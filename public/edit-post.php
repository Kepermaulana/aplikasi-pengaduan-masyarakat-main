                                ...
                                <div class="posts-section">              																															
										<div class="post-bar">																			
											<div class="job_descp">
												...
												?>
												<img src="foto<?php echo $hasil["gambar_pengaduan"]; ?>" class="mb-3 img-thumbnail" alt="">
												<?php
												} else {
													echo "";
												}
												...
												<form action="" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <textarea class="form-control" name="isi_post" cols="30" rows="10"><?php echo $hasil["isi_pengaduan"]; ?></textarea>                                                     
                                                    </div>
													<div class="form-group">
														<input type="file" name="foto">
													</div>
													<div>                                                 
                                                    <input type="submit" class="btn btn-primary" name="tombol" value="Update Postingan">
												...
												<?php
													...
													if($tombol) {
														...
														if ($update) {
															echo "Postingan berhasil di update";
															echo "<script>location='index.php';</script>";
														} else {
															echo "Post gagal di update";
														}
													}
												}													
												?>
