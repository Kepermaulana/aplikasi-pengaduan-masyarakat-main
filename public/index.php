							...
							<div class="col-lg-9 col-md-8 no-pd">
								<div class="main-ws-sec">
									...
									<div class="posts-section">
										...
										<?php
										$a = $koneksi->query("SELECT tb_pengaduan.
										tgl_pengaduan, tb_pengaduan.judul_pengaduan, tb_pengaduan.isi_pengaduan,
										tb_pengaduan.id_pengaduan,tb_pengaduan.gambar_pengaduan 
										FROM (tb_pengaduan LEFT JOIN tb_user ON 
										tb_pengaduan.id_user=tb_user.id_user) 
										...
										<div class="post-bar">
											<div class="post_topbar">
												...
												<?php 
													if(@$_SESSION["user"]) {
														if($tampil["foto"] != "" ) {
															echo "<img src='foto/profil/" . $tampil["foto"] . "' width='40	' height='40'/>"; 
															} else {
																echo "<img src='../img/avatar1.png' width='40	' height='40'/>";
															}
													} 
												?>															
													<div class="usy-name">
											...
											<div class="job_descp">
												...
												?>
												<img src="foto/<?php echo $ta["gambar_pengaduan"]; ?>" class="mb-3 img-thumbnail col-lg-12">
												<?php 
												} else {
													echo "";
												} 
